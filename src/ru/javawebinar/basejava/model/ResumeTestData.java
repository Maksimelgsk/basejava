...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        TextSection qualificationsText1 = new TextSection("* JEE AS: GlassFish (v2.1, v3), OC4J, JBoss, " +
                "Tomcat, Jetty, WebLogic, WSO2");
        TextSection qualificationsText2 = new TextSection("* Version control: Subversion, Git, Mercury, " +
                "ClearCase, Perforce");
        TextSection qualificationsText3 = new TextSection("* DB: PostgreSQL(наследование, pgplsql, PL/Python), Redis " +
                "(Jedis), H2, Oracle, MySQL, SQLite, MS SQL, HSQLDB");
        TextSection qualificationsText4 = new TextSection("* Languages: Java, Scala, Python/Jython/PL-Python, " +
                "JavaScript, Groovy");
        TextSection qualificationsText5 = new TextSection("* XML/XSD/XSLT, SQL, C/C++, Unix shell scripts");
        TextSection qualificationsText6 = new TextSection("* Java Frameworks: Java 8 (Time API, Streams), Guava, " +
                "Java Executor, MyBatis, Spring (MVC, Security, Data, Clouds, Boot)," + "\n" +  " JPA " +
                "(Hibernate, EclipseLink), Guice, GWT(SmartGWT, ExtGWT/GXT), Vaadin, Jasperreports, Apache Commons, " +
        ...
        TextSection qualificationsText10 = new TextSection("* Технологии: Servlet, JSP/JSTL, JAX-WS, REST, EJB, RMI, " +
                "JMS, JavaMail, JAXB, StAX, SAX, DOM, XSLT, MDB, JMX, JDBC, JPA, JNDI, JAAS, SOAP, " + "\n" + " " +
                "AJAX, Commet, HTML5, ESB, CMIS, BPMN2, LDAP, OAuth1, OAuth2, JWT.");
        TextSection qualificationsText11 = new TextSection("* Инструменты: Maven + plugin development, " +
                "Gradle, настройка Ngnix");
        TextSection qualificationsText12 = new TextSection("* администрирование Hudson/Jenkins, Ant + custom task, " +
                "SoapUI, JPublisher, Flyway, Nagios, iReport, OpenCmis, Bonita, pgBouncer");
        TextSection qualificationsText13 = new TextSection("* Отличное знание и опыт применения концепций ООП, SOA, " +
        ...
        experience.put(new Link("https://javaops.ru/", "Java Online Projects"), new Organization(
                ...
                LocalDate.now(), "Создание, " +
                "организация и проведение Java онлайн проектов и стажировок.", "Автор проекта.\n"));
        ...
        experience.put(new Link("https://www.luxoft.ru/", "Luxoft (Deutsche Bank)"), new Organization(
                ...
                Oracle).\s
                Реализация клиентской и серверной части CRM. Реализация RIA-приложения для администрирования,\s
        ...
        experience.put(new Link("https://www.yota.ru/", "Yota"), new Organization(
                ...
                LocalDate.of(2010, 12, 1),"Дизайн и имплементация Java EE фреймворка " +
                "для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, " +
        ...
        experience.put(new Link("http://enkata.com/", "Enkata"), new Organization(
                ...
                LocalDate.of(2008, 6, 1),"Реализация клиентской (Eclipse RCP) и " +
                "серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения " +
                "(OLAP, Data mining).", "Разработчик ПО\n"));
        experience.put(new Link("https://www.siemens.com/global/en.html", "Siemens AG"), new Organization(
                LocalDate.of(2005, 1, 1),
                LocalDate.of(2007, 2, 1),"Разработка информационной модели, " +
                "проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens " +
                "@vantage (Java, Unix).", "Разработчик ПО\n"));
        experience.put(new Link("http://www.alcatel.ru/", "Alcatel"), new Organization(
                LocalDate.of(1997, 9, 1),
                LocalDate.of(2005, 1, 1),"Тестирование, отладка, внедрение ПО " +
        ...
        education.put(new Link("http://www.ifmo.ru/", "Санкт-Петербургский национальный " +
